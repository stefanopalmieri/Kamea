...
Plotkin and Power~\cite{plotkin03} use algebraic operations and equations to give modular semantics to computational effects, showing that algebraic theories naturally decompose computational features. Hyland et al.~\cite{hyland06} develop the categorical framework connecting algebraic theories to monads. Our work shares the spirit of algebraic decomposition but operates in a different setting: we decompose reflective capabilities in finite non-associative algebras rather than computational effects in categories of algebras.
