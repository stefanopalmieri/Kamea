...
| Three-class decomposition (Z, C, N) is functorial invariant of all DichotomicRetractMagma models | Lean-proved | `Kamea/CatKripkeWallMinimal.lean` — `three_categories` | `lake build` |
